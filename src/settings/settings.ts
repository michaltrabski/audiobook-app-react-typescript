...
//   "https://dacmwwxjyw.cfolks.pl/files/audiobooks/";

export const FOLDERWITHAUDIOBOOKS =
  "https://files.dacmwwxjyw.cfolks.pl/audiobooks/";

export const ENDPOINT = FOLDERWITHAUDIOBOOKS + "api/";
export const marksStep = 60 * 4; // it marks steps on slider every 5 min
export const limitStep = 5; // it is how many more books will show on show more button click
